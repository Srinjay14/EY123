...
namespace Srinjay_Recipe.Controllers
{
    public class RecipesController : Controller
    {
        private readonly Srinjay_RecipeContext _context;

        public RecipesController(Srinjay_RecipeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Recipe != null ? 
                          ...
                          Problem("Entity set 'Srinjay_RecipeContext.Recipe'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Srinjay_RecipeContext.Recipe'  is null.");
            }
            var recipe = await _context.Recipe.FindAsync(id);
            if (recipe != null)
            {
